...
angular.module('xeditable').factory('editableThemes', function() {
  var themes = {
    ...
    'bs3': {
      ...
      errorTpl:    '<div class="editable-error help-block" ng-show="$error" ng-bind="$error"></div>',
      buttonsTpl:  '<span class="editable-buttons"></span>',
      submitTpl:   '<button type="submit" class="btn btn-icon-only btn-primary"><span class="fa fa-check"></span></button>',
      cancelTpl: '<button type="button" class="btn btn-icon-only btn-default" ng-click="$form.$cancel()">' +
