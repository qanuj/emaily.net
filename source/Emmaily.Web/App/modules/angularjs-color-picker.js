        ...
        return {
            ...
            link: function ($scope, element, attrs, control) {
                ...
                $scope.$watch('swatchColor', function(newValue) {
                   angular.element(element[0].querySelector('.color-picker-swatch')).css({ 'background-color': newValue });
                });
                ...
                $scope.$watch('grid', function(newValue) {
                    angular.element(element[0].querySelector('.color-picker-grid')).css({'background-color': newValue});
                    angular.element(element[0].querySelector('.color-picker-opacity')).css({ 'background-color': newValue });
                });
